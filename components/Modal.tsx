          ...
          >
            <header className="flex items-start justify-between gap-4 px-7 py-6 border-b border-white/[0.06]">
              <div>
                ...
                {description && (
                  <p className="text-xs text-white/55 mt-1">{description}</p>
                )}
              </div>
              <button
                onClick={onClose}
                className="w-9 h-9 flex items-center justify-center rounded-xl text-white/55 hover:text-white hover:bg-white/[0.06] transition-all flex-shrink-0"
              >
                <X className="w-4 h-4" />
              </button>
            </header>
